...
| input标签属性    | 值                                        | 描述                                       |
| ------------ | ---------------------------------------- | ---------------------------------------- |
| type         | button<br />  checkbox<br />  date <br /> datetime<br />  datetime-local<br />  email<br />  file<br />  hidden<br />  image<br />  month<br />  number<br />  password<br />  radio<br />  range<br />  reset<br />  submit<br />  text<br />  time<br />  url<br />  week | 指示 input 元素的类型。默认值是 "text"               |
